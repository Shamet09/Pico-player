/* font5x7.h - font 5x7 "classic" vendorizzato da Adafruit-GFX-Library
 * (glcdfont.c, licenza BSD - vedi lib/LICENSES.md).
 *
 * Ogni carattere occupa 5 byte; ogni byte e' una COLONNA di 8 pixel, con il
 * bit 0 in alto. 256 caratteri (codepage 437).
 * Rispetto all'originale sono stati rimossi gli #include e la macro PROGMEM,
 * che su RP2040 non servono.
 */
#ifndef PP_FONT5X7_H
#define PP_FONT5X7_H
...
#define FONT5X7_W       5
#define FONT5X7_H       7
#define FONT5X7_ADVANCE 6   /* 5 px di glifo + 1 px di spaziatura */
